...
/// The system prompt.
///
/// Deliberately plain. Kingdom's metaphor -- kings, models, prompts -- exists
/// to give the *user* a stance toward his agents; it is not information about
/// the work, and sending it only nudges the model into answering in costume
